...
<div class="flex py-[2vw] h-full bg-white px-[3vw] flex-col overflow-x-hidden slide-up-fade-in">
	...
	<div class="w-full mt-[1.5vw] md:mt-[0.4vw] flex flex-col gap-[1.2vw] md:gap-[0.6vw]">
		<div class="w-full flex flex-row justify-between items-center">
			<h1 class="text-[3vw] text-black md:text-[1.3vw] font-bold">
				{item.datePosted}
			</h1>
			<h1 class="text-[3vw] text-black md:text-[1.3vw] font-bold">₦199.99</h1>
			<h1 class="text-[3vw] text-black md:text-[1.3vw] font-bold">
				{item.minread} read
			</h1>
		</div>
	...
	<div class="flex flex-col md:flex-row mt-[3vw]">
		<img src={item.img} alt="news-pic" class="w-full md:w-[50vw] rounded-xl" />
		<div
