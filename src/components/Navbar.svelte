<script lang="ts">
  ...
  import LogoDark2 from "../image/logo4.png";
  ...
  <h1 class="text-[4vw] font-medium mt-[0] logo">
    <a href="/">
      <img
        src={Logo}
        alt=""
        class="w-[21vw] md:w-[8vw] hover:brightness-50 dark:hidden transition duration-500 ease-in-out"
      />
      <img
        src={LogoDark2}
        alt=""
        class="w-[21vw] md:w-[8vw] hidden dark:block hover:brightness-200 transition duration-500 ease-in-out"
      />
    </a>
  </h1>
  ...
  <div class="flex flex-row items-center gap-[3vw] hidden md:flex mt-[-1vw]">
    <div class="flex flex-row gap-[3vw] text-[1.2vw] font-semibold ml-[5vw]">
      <a href="/work" class={currentPath === "/work" ? "active" : ""}>
        <h1 class="text-[#868686] dark:text-[#6d6e6d] hover:text-black dark:hover:text-white transition duration-500 ease-in-out page1">
          Work
        </h1>
      </a>

      <a href="/about" class={currentPath === "/about" ? "active" : ""}>
        <h1 class="text-[#868686] dark:text-[#6d6e6d] hover:text-black dark:hover:text-white transition duration-500 ease-in-out page2">
          About
        </h1>
      </a>

      <h1 class="text-[#868686] cursor-pointer dark:text-[#6d6e6d] hover:text-black dark:hover:text-white transition duration-500 ease-in-out page3">
        Resume
      </h1>

      <a href="/more" class={currentPath === "/more" ? "active" : ""}>
        <h1 class="text-[#868686] dark:text-[#6d6e6d] hover:text-black dark:hover:text-white transition duration-500 ease-in-out page4">
          More
        </h1>
      </a>
    </div>
...
{#if isMobileView && menuOpen}
  <div class="fixed inset-0 z-50">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8" on:click={toggleMenu} on:keydown={handleKeyDown} tabindex="-1" role="button" aria-label="Close"></div>
    <div class="w-full h-full md:w-64 bg-[#dfdfdf] dark:bg-[black] mt-[1rem]" in:fade={{ duration: 500 }} out:fade={{ duration: 700 }}>
      <div class="block md:hidden">
        <div class="flex flex-col gap-[2rem] items-center justify-center">
          <a
            href="/"
            class={currentPath === "/" ? "active text-[#6a6868] dark:text-[#989898] hover:text-black dark:hover:text-white transition duration-500 ease-in-out mt-[3rem] text-xl sm:text-3xl font-semibold" : "text-[#6a6868] dark:text-[#989898] hover:text-black dark:hover:text-white transition duration-500 ease-in-out mt-[3rem] text-xl sm:text-3xl font-semibold"}
          ...
          <a
            href="/work/"
            class={currentPath === "/work" ? "active text-[#6a6868] dark:text-[#989898] hover:text-blue dark:hover:text-white transition duration-500 ease-in-out text-xl sm:text-3xl font-semibold" : "text-[#6a6868] dark:text-[#989898] hover:text-black dark:hover:text-white transition duration-500 ease-in-out text-xl sm:text-3xl font-semibold"}
          ...
          <a
            href="/about/"
            class={currentPath === "/about" ? "active text-[#6a6868] dark:text-[#989898] hover:text-black dark:hover:text-white transition duration-500 ease-in-out text-xl sm:text-3xl font-semibold" : "text-[#6a6868] dark:text-[#989898] hover:text-black dark:hover:text-white transition duration-500 ease-in-out text-xl sm:text-3xl font-semibold"}
            in:fly={{ y: 200, duration: 1000 }}
            out:fly={{ y: 200, duration: 1500 }}
          >
            About
          </a>
          <div class="text-[#6a6868] dark:text-[#989898] hover:text-black dark:hover:text-white transition duration-500 ease-in-out text-xl sm:text-3xl font-semibold" in:fly={{ y: 200, duration: 1300 }} out:fly={{ y: 200, duration: 1000 }}>
            Resume
          </div>
          <a
            href="/more/"
            class={currentPath === "/more" ? "active text-[#6a6868] dark:text-[#989898] hover:text-black dark:hover:text-white transition duration-500 ease-in-out text-xl sm:text-3xl font-semibold" : "text-[#6a6868] dark:text-[#989898] hover:text-black dark:hover:text-white transition duration-500 ease-in-out text-xl sm:text-3xl font-semibold"}
