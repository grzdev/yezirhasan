...
<div class="flex justify-center items-center">
  <div class="flex flex-col overflow-x-hidden w-full ">
    ...
    <div class="flex items-center w-full px-[3vw] md:px-[1.7vw] justify-between">
      ...
      <!-- Filter Button -->
      <button
        class="p-2 bg-[#6a6868] dark:bg-[#d7d7d7] w-[7vw] h-[7vw] md:w-[3vw] md:h-[2.5vw] hover:bg-black dark:hover:bg-[#d7d7d7] md:dark:hover:bg-[#83ff87] hover:text-[white] dark:hover:text-[black] hover:bg-[#3bbb67] dark:hover:bg-[#83ff87] transition duration-500 ease-in-out flex justify-center items-center rounded-md"
      ...
      <div class="categories flex items-start gap-[0.5rem] md:gap-[0] md:items-center flex-col md:flex-row justify-between mb-[3vw] md:mb-[0] p-[2vw] px-[6vw] md:py-[0.1vw] md:px-[3vw]  items-start" transition:slide>
        ...
        <div class="flex flex-row gap-4 items-center  mr-[-1.3vw] items-start">
          <div class="flex gap-4 items-center">
            <span class="text-[3vw] cursor-pointer md:text-[1.3vw] hover:text-black dark:hover:text-white text-[#6a6868] dark:text-[#989898] font-semibold transition duration-500 ease-in-out">
