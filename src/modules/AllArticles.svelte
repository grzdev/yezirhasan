...
<div class="px-[3vw] py-[2vw] overflow-x-hidden">
	...
	>
		...
		<button
			class="p-2 bg-[#6a6868] dark:bg-[#d7d7d7] w-[10vw] h-[9vw] md:w-[3vw] md:h-[2.5vw] hover:bg-black dark:hover:bg-[#83ff87] hover:text-[white] dark:hover:text-[black] hover:bg-[#3bbb67] dark:hover:bg-[#83ff87] transition duration-500 ease-in-out flex justify-center items-center rounded-md"
			on:click={toggleCategories}
			aria-label="Filter work"
		>
			<h1
				class="text-[white] dark:text-[black] text-[5vw] md:text-[1.6vw]"
			>
	...
	{#if showCategories}
		<div
			class="categories ml-[8vw] md:ml-[3vw] flex items-start gap-[0.5rem] md:gap-[0] md:items-center flex-col md:flex-row justify-between mt-2 mb-[3vw] md:mb-[0] px-[1vw] items-start"
			transition:slide
		>
			<div class="flex gap-2 items-center">
              ...
              {category === selectedCategory
							...
							: 'bg-[#6a6868] dark:bg-[#d7d7d7] text-[white] dark:text-[black] hover:bg-black dark:hover:bg-[#83ff87] hover:text-[white] dark:hover:text-[black]'}"
						aria-label={category}
					>
						{category}
					</button>
			...
			<!-- Reading Time Slider -->
			<div
				class="flex flex-row gap-4 items-center mr-[-1vw] items-start"
			>
				<div class="flex gap-4 items-center">
					<span
						class="text-[3vw] md:text-[1.3vw] hover:text-black dark:hover:text-white text-[#6a6868] dark:text-[#989898] font-semibold transition duration-500 ease-in-out"
					>
